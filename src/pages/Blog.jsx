...
export default function Blog() {
  const defaultPosts = [
    {
      id: 1,
      title: "Why I Love Building Web Apps with the MERN Stack",
      text: "Working with MongoDB, Express, React, and Node has shown me how quickly an idea can become a real product. I like the balance of having full control over both the frontend and backend. Turning a simple concept into a fast, functional web application is the part I enjoy the most.",
    },
    {
      id: 2,
      title: "Why I Enjoy Creating Practical Projects with MERN",
      text: "Working with MongoDB, Express, React, and Node has shown me how quickly an idea can become a real product. I like the balance of having full control over both the frontend and backend. Turning a simple concept into a fast, functional web application is the part I enjoy the most.",
    },
    {
      id: 3,
