...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/Yashvant203' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/yashvant-makwana/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:makwanayash0099@gmail.com' },
      ...
      <div className="home-top">
        ...
        >
          ...
          <motion.div className="info-cards">
            {[
              { label: '📍 Location', value: 'Nadiad, Gujarat, India' },
              { label: '💼 Expertise', value: 'Developer, Problem Solving' },
              { label: '📧 Contact', value: 'makwanayash0099@gmail.com' },
            ].map((info, i) => (
